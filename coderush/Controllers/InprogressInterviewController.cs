...
{
    public class InprogressInterviewController : Controller
    {
        ...
        public InprogressInterviewController(ILogger<HomeController> logger, UserManager<ApplicationUser> userManager,
        ...
        public IActionResult InprogressIndex()
        {
            ...
            data = (from candidate in _context.CandidateMaster.OrderByDescending(x => x.Id)
                    where !candidate.IsDelete && candidate.Status == 2
